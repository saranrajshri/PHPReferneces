...
$query=mysql_query("INSERT INTO users VALUES('','$un','$fn','$ln','$em','$pswd','','','$d','./img/default.jpg','','','No status','Not defined','Not defined','Not defined','Not defined','Not defined','Not defined','Not defined','Not defined','Not defined','Not defined','Not defined','yes','no','-','-','-','','Not defined')");
//Check for existence
...
?>
<img src="./img/thank-you.jpg" width="500" height="300" style="position:absolute;top:140px;left:120px;">
<h1 style="color:#045dad;font-size:20px;position:absolute;top:460px;left:170px">Thank you for stopping in jumbonetwork</h1>
<div class="signup">
...
<div id="button">
<input type="submit" name="reg" value="Create my Account" onclick="loadingfb()"class="myButton" style="sposition:absolute;right:330px;top:450px;">
</div>
</form>
</div>
<div id="foot">
