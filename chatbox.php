...
<div id="cont-header">
<center><h1>Select a friend to chat</h1></center>
</div>
<div id="cont-body" style="padding:10px">
<?php
if($countFriends!=0){
foreach($friendArray12 as $key => $value){
	...
	{
		echo'<div id="profile_pictures" style="padding:10px;margin-bottom:15px">
<img src=userdata/profile_pics/'.$friendProfilePic.' width="60" height="60" style="border:1px solid #ccc;">
</div>';
		echo'<div id="nameofuser" style="margin-top:-50px;margin-left:10px">
<a href="send_message.php?profile_id='.$friendId.'" style="padding-left:70px;color:#045dad;font-size:15px;font-weight:bold;text-decoration:none;">'.$friendUsername.'</a>
</div>
<div id="tap">
<a href="send_message.php?profile_id='.$friendId.'" style="color:#04dad;font-size:15px;text-decoration:none;float:right;margin-top:-20px;margin-right:20px;font-weight:bold;">Chat with '.$friendUsername.'</a>
</div>
<br><hr>';
	}
}
