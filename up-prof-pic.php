...
$profile_pic_query = mysql_query ("UPDATE users SET profile_pic='$rand_dir_name/$profile_pic_name'WHERE id='$user' ");
...
<div id="cont-header">
<center><h1>Update your profile picture</h1></center>
</div>
<div id="cont-body" style="border:1px solid #ccc;boder-top:1px solid #045dad;padding:10px;">
<form action="#" method="post" enctype="multipart/form-data"> 
<center><img src="<?php echo $profile_pic;?>" width="510" height="320"></center><br>
<center><input type="file" style="padding-left:50px" name="profilepic"></center><br>
