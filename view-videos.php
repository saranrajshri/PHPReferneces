...
<div id="op">
<a href="#">View photos of <?php echo $typ_first_name;?></a><hr>
<a href="#">View videos of <?php echo $typ_first_name;?></a><hr><hr>
</div><br>
<div id="information">
...
<div id="cont-header" >
<h1><?php echo $typ_user_name;?>'s Videos</h1>
</div>
<?php
$querry=mysql_query("SELECT * FROM videos WHERE user_id='$username'");
while($run=mysql_fetch_array($querry)){
$url=$run['url'];
 ?>
<div id="video_box">
<video src="./<?php echo $url ?>" style="padding:10px"></video><br>
</a>
</div>
