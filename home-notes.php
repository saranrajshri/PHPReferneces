...
<div id="cont-body" style="padding:10px;background:#f2f2f2">
<center><h1>Click here to create note</h1></center>
<center><a href="createnote.php"><label for ="add" id="hoov"><img src="./img/more.gif" style="padding:10px;border:1px dashed #ccc;background:#fff;" title="Click to create a note" width="80" height="80" ></label></center></a>
