...
<div id="cont-header">
<center><h1>Tell somthing about yourself</h1></center>
</div>
<div id="cont-body" style="border:1px solid #ccc;boder-top:1px solid #o45dad;padding:10px;">
<form action="#" method="post">
<textarea rows="5" name="post" cols="90" style="font-size:15px;font-family:arial,helvetica,sans-serif" placeholder="Enter about you here..."></textarea><br><br>
<center><input type="submit" name="sub" value="Save changes" class="button blue"></center>
</form>
</div>
</div>
<?php
...
{
	mysql_query("UPDATE users SET bio='$post' WHERE id='$user'");
