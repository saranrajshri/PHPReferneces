...
<div id="cont-header">
<center><h1>Results for <?php echo $name;?></h1></center>
</div>
<div id="cont-body">
<?php
$get_comments=mysql_query("SELECT * FROM users WHERE username='$name' ORDER BY id DESC");
	$comment=mysql_fetch_array($get_comments);
	$name=$comment['username'];
	$id=$comment['id'];
	$profilepic_info=$comment['profile_pic'];
...
echo'
<div class="postsforuser" style="margin-top:20px;width:57%;margin-left:10px;padding-bottom:20px;">
<div id="profile_pictures">
<a href="profile.php?profile_id='.$id.'"><img src='.$profilepic_info.' width="60" height="60" style="border:1px solid #ccc;"></a>
</div>
<div id="nameofuser" style="margin-top:-60px;">
<a href="profile.php?profile_id='.$id.'" style="padding-left:70px;color:#045dad;font-size:15px;font-weight:bold;text-decoration:none;">'.$name.'</a></div>
<div id="msg-cont" style="padding-left:70px;padding-top:30px;">
</div>
<hr style="margin-top:20px;width:170%;">
