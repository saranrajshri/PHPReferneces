...
<div id="cont-header">
<center><h1>Edit your profile <?php echo $log_user_name; ?></h1></center>
</div>
...
<a href="edit-info.php?profile_id=<?php echo $user;?>" style="padding:10px;color:#045dad;font-size:15px;text-decoration:none"> 2) Edit your information</a> 
<a href="edit-info.php?profile_id=<?php echo $user;?>" style="padding:10px;color:#045dad;font-size:15px;text-decoration:none;margin-left:475px">[ edit ]</a> 
<hr style="width:100%;margin-left:0px;margin-top:10px;"><br>
