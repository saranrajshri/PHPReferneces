...
<?php
 ...
 <?php 
		...
		if (isset($_GET['img_destination_or_location_url'])) {
		$url= mysql_real_escape_string($_GET['img_destination_or_location_url']);
		if(ctype_alnum($url)) {
		//
		$check=mysql_query("SELECT url FROM photos WHERE url='$url'");
...
?>
<div id="view_box" style="width:90%;height:100%;">
